...
public class YouKeRigisterOneActivity extends ActionBarActivity implements OnClickListener{
	
	private final static String TAG = YouKeRigisterOneActivity.class.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getActionBar().hide();
		setContentView(R.layout.youke_rigister);
	...
	private void rigister(final String phone2, final String password1) {
		new Thread(){
			...
			public void run() {
				super.run();
				r = WebServiceUtils.add2(phone2,"",ConstantValue.YOUKE,"0",password1,"游客","","","");
