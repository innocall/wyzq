...
public class RigisterQinShuThreeActivity extends ActionBarActivity implements OnClickListener{
	
	private final static String TAG = RigisterQinShuThreeActivity.class.getSimpleName();
	...
	private EditText login_phone,login_password,login_password2;
				...
				case RIGISTER:
					...
					if(r != null) {
						if(r.getRows().equals("1")) {
							...
							Intent intent = new Intent(RigisterQinShuThreeActivity.this,LoginActivity.class);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getActionBar().hide();
		setContentView(R.layout.rigister_qinshu);
	...
	private void rigister(final String phone2, final String password1) {
		new Thread(){
			...
			public void run() {
				super.run();
				r = WebServiceUtils.add2(phone2,city,ConstantValue.QINGSHU,xiaoId,password1,"","","",fangId);
