...
public class CityActivity extends ActionBarActivity implements OnClickListener{
			...
			switch(msg.what) {
				case XIAOQU:
					if(list != null && list.size() > 0) {
						...
						accept_no_order1.setText("没有获取到城市列表");
					}
					break;
			}
		};
	...
	class MyXiaoQuAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.xiaoqu_name.setText(result.get("city"));
			holder.xiaoqu_id.setText(result.get("rowId"));
			return convertView;
		}
